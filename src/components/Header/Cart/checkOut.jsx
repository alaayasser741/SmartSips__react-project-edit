          ...
          <div className='Billing_info container col-md-4 col-10'>
            ...
            <form className="row g-1">
              <div className="col-12">
                ...
                <input type="text" className="form-control h-50" id="inputName" placeholder="Ahmed" />
              </div>
              <div className="Billing_AddressInput col-12">
                <label for="inputAddress" className="form-label">Billing Address</label>
                <input type="text" className="form-control h-50" id="inputAddress" placeholder="Sammound-Bana"></input>
                <div><img src={'./icons/location-removebg-preview.png'} alt='location' /></div>
              </div>

              <div className="col-md-6">
                <label for="inputCity" className="form-label">City</label>
                <input type="text" className="form-control" id="inputCity" placeholder='Samnoud' />
              </div>
              <div className="col-md-6">
                <label for="inputZipCode" className="form-label">Zip Code</label>
                <input type="text" className="form-control" id="inputZipCode" placeholder='1234' />
              </div>
          ...
          <div className='Credit_Card_info col-md-4 col-10' >
            ...
            <form className="row g-1">
              <div className="col-12">
                ...
                <input type="text" className="form-control h-50" id="inputHolderName" placeholder="Ahmed Hatem" />
              </div>
              <div className="Billing_AddressInput col-12">
                <label for="inputCardNumber" className="form-label">Card Number</label>
                <input type="text" className="form-control h-50" id="inputCardNumber" placeholder="5642-2345-2342-2348"></input>
              </div>
