...
export default function Popup(props) {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        const product = productsWithImages.find((item) => item.id === productId);
  ...
  const handleEditProduct = async (e) => {
    ...
    try {
      ...
      const response = await axiosInstance.patch(`/products_api/${productId}/update`, updatedProduct);
      console.log(response);
      setShowUploadForm(1)
                    ...
                    {showUploadForm === 1 ?
                      <div className='wrapper__section'>
                        ...
                        <form action="#" onClick={handleFileClick}>
                          ...
                          />
                          {imageUploaded ? <span style={{ color: 'green' }}>Image uploaded successfully!</span> : <p>Browser Your File</p>}
                        </form>
                        <button aria-label="submit the form" className="image-btn" onClick={handleUploadSubmit}>Update</button>
                      </div> : <div>
                        ...
                        <div className="ok-btn-invoice">
                          <button aria-label="submit the form" onClick={handleEditProduct} className="btn">
                            &nbsp; Update
                          </button>
                        </div>
